...
const ListSettingsModal = ({ showModal, hideModal, confirmModal, id }) => {
    ...
    let baseUrlApi = process.env.REACT_APP_API_URL + "api/index.php/url/list";
    let baseTypesApi = process.env.REACT_APP_API_URL + "api/types.php/list?type=";
    ...
    useEffect(() => {
        if (loading == false) {
            ...
            let apiUrl = process.env.REACT_APP_API_URL + "api/types.php/save";
            axios.post(apiUrl, {
                type: 'daily',
